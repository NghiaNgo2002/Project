  ...
  <div className="col-lg-4">
    <div className="blog-article">
      <div className="blog-article__image">
        <a href={link}>
          <img alt="Image" data-sizes="auto" data-srcset={imageSrc} src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" className="lazyautosizes lazyloaded" sizes="365px" srcSet={imageSrc} />
        </a>
      </div>
